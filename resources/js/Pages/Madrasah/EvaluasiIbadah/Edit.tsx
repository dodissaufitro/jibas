...
interface Props {
    evaluasi: EvaluasiIbadah;
    siswa: Siswa[];
}

export default function Edit({ evaluasi, siswa }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        siswa_id: evaluasi.siswa_id.toString(),
        bulan: evaluasi.bulan,
        tahun: evaluasi.tahun,
        shalat_wajib: evaluasi.shalat_wajib.toString(),
        shalat_dhuha: evaluasi.shalat_dhuha.toString(),
        shalat_tahajud: evaluasi.shalat_tahajud.toString(),
        tadarus_quran: evaluasi.tadarus_quran.toString(),
        hafalan_quran: evaluasi.hafalan_quran.toString(),
        puasa_sunnah: evaluasi.puasa_sunnah.toString(),
        infaq_sedekah: evaluasi.infaq_sedekah.toString(),
        akhlak_harian: evaluasi.akhlak_harian.toString(),
        catatan: evaluasi.catatan || '',
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('madrasah.evaluasi-ibadah.update', evaluasi.id));
    };
    ...
    return (
        <SidebarLayout>
            <Head title="Edit Evaluasi Ibadah" />
            
            <div className="p-6">
                <div className="mb-6">
                    <h1 className="text-3xl font-bold text-gray-800">Edit Evaluasi Ibadah</h1>
                    <p className="text-gray-600 mt-2">Perbarui evaluasi pelaksanaan ibadah siswa</p>
                </div>
