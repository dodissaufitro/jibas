...
export default function Index({ kelas }: Props) {
    ...
    return (
        <SidebarLayout>
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <Link
                    href={route('master.kelas.create')}
                                                ...
                                                <tr key={item.id} className="hover:bg-gray-50">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <div className="flex space-x-2">
                                                            <Link
                                                                href={route('master.kelas.edit', item.id)}
                            ...
                            {kelas.last_page > 1 && (
                                <div className="mt-6 flex items-center justify-between">
                                    <div className="text-sm text-gray-700">
                                        Menampilkan <span className="font-medium">{(kelas.current_page - 1) * kelas.per_page + 1}</span> sampai{' '}
                                        <span className="font-medium">
                                            {Math.min(kelas.current_page * kelas.per_page, kelas.total)}
                                        </span>{' '}
                                        dari <span className="font-medium">{kelas.total}</span> data
                                    </div>
