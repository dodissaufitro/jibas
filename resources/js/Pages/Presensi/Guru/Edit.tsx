...
export default function Edit({ presensi, guru }: Props) {
    const [searchTerm, setSearchTerm] = useState('');
    
    const { data, setData, patch, processing, errors } = useForm({
        guru_id: presensi.guru_id.toString(),
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        patch(route('presensi.guru.update', presensi.id));
    };
