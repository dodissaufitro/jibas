...
export default function Edit({ pembayaran, tagihan }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        tagihan_id: pembayaran.tagihan_id.toString(),
        tanggal_bayar: pembayaran.tanggal_bayar,
        jumlah_bayar: pembayaran.jumlah_bayar.toString(),
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        patch(route('keuangan.pembayaran.update', pembayaran.id));
    };
                ...
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm rounded-lg">
                        <form onSubmit={submit} className="p-6 space-y-6">
                            ...
                            <div>
                                <label htmlFor="no_transaksi" className="block text-sm font-medium text-gray-700">
                                    No Transaksi
                                </label>
                                <input
                                    id="no_transaksi"
                                    type="text"
                                    value={pembayaran.no_transaksi}
