...
export default function Edit({ hafalan, santri }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        siswa_id: hafalan.siswa_id.toString(),
        juz: hafalan.juz.toString(),
        surat: hafalan.surat,
        ayat_dari: hafalan.ayat_dari.toString(),
        ayat_sampai: hafalan.ayat_sampai.toString(),
        tanggal_setoran: hafalan.tanggal_setoran,
        nilai: hafalan.nilai,
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(route('pesantren.hafalan.update', hafalan.id));
    };
                ...
                <div className="relative py-6 sm:py-8">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-slate-600 mt-1">
                            Perbarui data setoran hafalan Al-Qur'an santri
                        </p>
                    </div>
