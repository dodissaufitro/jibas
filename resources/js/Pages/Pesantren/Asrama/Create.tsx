...
export default function Create({ pengurus }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('pesantren.asrama.store'), {
            ...
            <div className="relative py-6 sm:py-8">
                ...
                <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-6">
                        ...
                        <h1 className="mt-2 text-2xl font-bold text-slate-900">Tambah Asrama Baru</h1>
                        <p className="text-sm text-slate-600">Buat data asrama lengkap dengan kapasitas dan fasilitas.</p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5"
                                    placeholder="Kasur, Lemari, Kamar mandi dalam"
                                />
                            </div>
