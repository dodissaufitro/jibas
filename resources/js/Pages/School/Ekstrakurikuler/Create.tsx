...
export default function Create({ pembina }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('school.ekstrakurikuler.store'), {
    ...
    return (
        <SidebarLayout>
            ...
            <div className="p-6">
                <div className="mb-6">
                    <h1 className="text-3xl font-bold text-gray-800">Tambah Ekstrakurikuler</h1>
                    <p className="text-gray-600 mt-2">Buat ekstrakurikuler baru untuk siswa</p>
                </div>
