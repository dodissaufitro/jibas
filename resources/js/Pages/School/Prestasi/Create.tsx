...
export default function Create({ siswa }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('school.prestasi.store'));
    };
    ...
    return (
        <SidebarLayout>
            ...
            <div className="p-6">
                <div className="mb-6">
                    <h1 className="text-3xl font-bold text-gray-800">Tambah Prestasi Siswa</h1>
                    <p className="text-gray-600 mt-2">Catat prestasi siswa baik akademik maupun non-akademik</p>
                </div>
                        ...
                        <div className="border-b pb-4">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">Upload sertifikat atau bukti prestasi</p>
                                </div>
