...
export default function Create({ ujian, nextNomor }: Props) {
    ...
    const [showOpsiE, setShowOpsiE] = useState(false);

    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        post(route('ujian.soal.store', ujian.id));
    };
    ...
    return (
        <SidebarLayout>
            ...
            <div className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 mb-8">
                ...
                <h1 className="text-4xl font-bold text-white mb-2">Tambah Soal Baru</h1>
