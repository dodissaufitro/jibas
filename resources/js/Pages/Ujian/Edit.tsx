...
export default function Edit({ ujian, mataPelajaran, guru, kelas, tahunAjaran, semester }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        mata_pelajaran_id: ujian.mata_pelajaran_id.toString(),
        guru_id: ujian.guru_id.toString(),
        kelas_id: ujian.kelas_id.toString(),
        tahun_ajaran_id: ujian.tahun_ajaran_id.toString(),
        semester_id: ujian.semester_id.toString(),
        judul_ujian: ujian.judul_ujian,
        jenis_ujian: ujian.jenis_ujian,
        tanggal_ujian: ujian.tanggal_ujian?.split('.')[0] || '', // Remove milliseconds for datetime-local input
        durasi_menit: ujian.durasi_menit.toString(),
        bobot: ujian.bobot.toString(),
        kkm: ujian.kkm.toString(),
