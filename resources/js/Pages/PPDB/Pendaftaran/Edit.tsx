...
export default function Edit({ pendaftaran, tahunAjaran, jenjang, jurusan }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        tahun_ajaran_id: pendaftaran.tahun_ajaran_id.toString(),
        jenjang_id: pendaftaran.jenjang_id.toString(),
        jurusan_id: pendaftaran.jurusan_id?.toString() || '',
        ...
        penghasilan_ortu: pendaftaran.penghasilan_ortu.toString(),
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        patch(route('ppdb.pendaftaran.update', pendaftaran.id));
    };
                        ...
                        <form onSubmit={submit} className="p-6 space-y-8">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label htmlFor="no_pendaftaran" className="block text-sm font-medium text-gray-700">
                                            No. Pendaftaran
                                        </label>
                                        <input
                                            id="no_pendaftaran"
