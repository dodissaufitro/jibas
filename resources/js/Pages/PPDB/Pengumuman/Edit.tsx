...
export default function Edit({ pengumuman, tahunAjaran }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        tahun_ajaran_id: pengumuman.tahun_ajaran_id.toString(),
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('ppdb.pengumuman.update', pengumuman.id));
    };
