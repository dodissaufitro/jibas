...
export default function Edit({ user, roles, userRoles }: Props) {
    ...
    useEffect(() => {
        setSelectedRoles(roles.filter(r => data.roles.includes(r.id)));
    }, [data.roles]);
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2">
                                Password Baru
                                <span className="text-gray-500 font-normal text-xs ml-2">(kosongkan jika tidak ingin mengubah)</span>
                            </label>
                            <input
                                type="password"
                                value={data.password}
